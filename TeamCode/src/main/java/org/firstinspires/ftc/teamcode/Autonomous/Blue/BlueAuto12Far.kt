...
class BlueAuto12Far: NextFTCOpMode() {
    ...
    override fun onStartButtonPressed() {
        PedroComponent.Companion.follower.setStartingPose(Pose(63.0, 9.7, PI / 2.0))
        buildPaths()
    ...
    fun buildPaths() {
        val pushPath = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierLine(
        ...
        val intakePath1 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierCurve(
                Pose(144.0 - 50.000, 9.700),
        ...
        val shootPath1 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierCurve(
                Pose(144.0 - 11.500, 35.250),
        ...
        val intakePath2 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierCurve(
                Pose(144.0 - 58.750, 23.500),
        ...
        val shootPath2 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierCurve(
        ...
        val intakePath3 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierLine(
        ...
        val shootPath3 = PedroComponent.Companion.follower.pathBuilder().addPath(
            BezierLine(
                Pose(144.0 - 17.500, 82.250),
                Pose(144.0 - 59.500, 82.250)
            )
        ...
        val leavePath = PedroComponent.Companion.follower.pathBuilder().addPath(
