...
public class PedroConstants {
    ...
    public static PinpointConstants localizerConstants = new PinpointConstants()
            ...
            .hardwareMapName(ConfigConstants.INSTANCE.PINPOINT())
    ...
    public static MecanumConstants driveConstants = new MecanumConstants()
            .maxPower(1)
            .rightFrontMotorName(ConfigConstants.INSTANCE.FRONT_RIGHT())
            .rightRearMotorName(ConfigConstants.INSTANCE.BACK_RIGHT())
            .leftRearMotorName(ConfigConstants.INSTANCE.BACK_LEFT())
            .leftFrontMotorName(ConfigConstants.INSTANCE.FRONT_LEFT())
