...
public class PedroConstants {
    ...
    public static MecanumConstants driveConstants = new MecanumConstants()
            .maxPower(1)
            .rightFrontMotorName(ConfigConstants.INSTANCE.frontRight())
            .rightRearMotorName(ConfigConstants.INSTANCE.backRight())
            .leftRearMotorName(ConfigConstants.INSTANCE.backLeft())
            .leftFrontMotorName(ConfigConstants.INSTANCE.frontLeft())
